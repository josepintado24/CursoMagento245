...
--
-- Host: localhost    Database: m2_test
-- ------------------------------------------------------
...
INSERT INTO `admin_passwords` VALUES (1,1,'13c4d5f7908980fedda843b9b7592f25e0784eab209144a665a90586c8a4d7bc:cfBhkim3WWqqc19J2HNmmtEGIXxmqmdN:3_32_2_67108864',0,1672461790),(2,2,'de5a7c7eedb1b73c5607a30c18fabceff4e288e0aa92e2af13cbb00f40051fe2:U02td6FTYWrZUJuQcHlrpmrwywwHjTdF:3_32_2_67108864',0,1672525957);
...
INSERT INTO `admin_system_messages` VALUES ('da332d712f3215b9b94bfa268c398323',2,'2022-12-31 22:36:49');
...
INSERT INTO `admin_user` VALUES (1,'admin','admin','admin@admin.com','admin','13c4d5f7908980fedda843b9b7592f25e0784eab209144a665a90586c8a4d7bc:cfBhkim3WWqqc19J2HNmmtEGIXxmqmdN:3_32_2_67108864','2022-12-31 04:43:10','2022-12-31 23:28:01','2022-12-31 23:28:01',3,0,1,NULL,NULL,NULL,'en_US',0,NULL,NULL),(2,'Jose','Pintado','jose.pintado@nttdata.com','jose.luis','de5a7c7eedb1b73c5607a30c18fabceff4e288e0aa92e2af13cbb00f40051fe2:U02td6FTYWrZUJuQcHlrpmrwywwHjTdF:3_32_2_67108864','2022-12-31 22:32:37','2022-12-31 22:38:03','2022-12-31 22:32:56',1,0,1,'{\"configState\":{\"catalog_search\":\"1\"}}',NULL,NULL,'en_US',0,NULL,NULL);
...
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb3 COMMENT='Admin User sessions table';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `admin_user_session` VALUES (1,NULL,1,0,'2022-12-31 22:31:17','2022-12-31 22:31:56','127.0.0.1'),(2,NULL,1,0,'2022-12-31 22:32:00','2022-12-31 22:32:05','127.0.0.1'),(3,NULL,2,1,'2022-12-31 22:32:56','2022-12-31 22:38:03','127.0.0.1'),(4,NULL,1,1,'2022-12-31 23:28:01','2022-12-31 23:38:06','127.0.0.1');
...
INSERT INTO `adminnotification_inbox` VALUES (1,4,'2022-12-31 04:43:08','Disable Notice','To improve performance, collecting statistics for the Magento Report module is disabled by default. \nYou can enable it in System Config.','',0,0);
...
INSERT INTO `authorization_role` VALUES (1,0,1,1,'G',0,'2','Administrators'),(2,1,2,0,'U',1,'2','admin'),(3,1,2,0,'U',2,'2','jose.luis');
...
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb3 COMMENT='Catalog Category Table';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `catalog_category_entity` VALUES (1,3,0,'2022-12-31 04:43:06','2022-12-31 23:30:05','1',0,0,3),(2,3,1,'2022-12-31 04:43:06','2022-12-31 04:43:06','1/2',1,1,0),(3,3,1,'2022-12-31 23:29:18','2022-12-31 23:30:05','1/3',2,1,1),(4,3,3,'2022-12-31 23:30:05','2022-12-31 23:30:05','1/3/4',1,2,0);
...
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8mb3 COMMENT='Catalog Category Integer Attribute Backend Table';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `catalog_category_entity_int` VALUES (1,69,0,1,1),(2,69,0,2,1),(3,46,0,2,1),(4,46,0,3,1),(5,54,0,3,1),(6,69,0,3,1),(7,70,0,3,0),(8,71,0,3,0),(9,46,0,4,1),(10,54,0,4,1),(11,69,0,4,1),(12,70,0,4,0),(13,71,0,4,0);
...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb3 COMMENT='Catalog Category Text Attribute Backend Table';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `catalog_category_entity_text` VALUES (1,50,0,4,'js'),(2,51,0,4,'js');
...
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8mb3 COMMENT='Catalog Category Varchar Attribute Backend Table';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `catalog_category_entity_varchar` VALUES (1,45,0,1,'Root Catalog'),(2,52,0,2,'PRODUCTS'),(3,45,0,2,'Default Category'),(4,45,0,3,'Cursos'),(5,52,0,3,'PRODUCTS'),(6,63,0,3,'category-full-width'),(7,119,0,3,'cursos'),(8,45,0,4,'Cursos JS'),(9,49,0,4,'js'),(10,52,0,4,'PRODUCTS'),(11,63,0,4,'category-full-width'),(12,119,0,4,'js'),(13,120,0,4,'js');
...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb3 COMMENT='Catalog Product To Category Linkage Table';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `catalog_category_product` VALUES (1,4,1,0),(2,4,2,0);
...
INSERT INTO `catalog_category_product_index_store1` VALUES (2,1,0,1,1,4),(2,2,0,1,1,4);
...
INSERT INTO `catalog_product_entity` VALUES (1,4,'simple','js parte 1',0,0,'2022-12-31 23:33:27','2022-12-31 23:35:12'),(2,4,'simple','js parte 2',0,0,'2022-12-31 23:37:32','2022-12-31 23:37:32');
...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb3 COMMENT='Catalog Product Datetime Attribute Backend Table';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `catalog_product_entity_datetime` VALUES (1,94,0,1,'2022-12-31 00:00:00'),(2,94,0,2,'2022-12-31 00:00:00');
...
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb3 COMMENT='Catalog Product Decimal Attribute Backend Table';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `catalog_product_entity_decimal` VALUES (1,77,0,1,100.000000),(2,82,0,1,4.000000),(3,77,0,2,1000.000000),(4,82,0,2,4.000000);
...
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb3 COMMENT='Catalog Product Integer Attribute Backend Table';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `catalog_product_entity_int` VALUES (1,97,0,1,1),(2,136,0,1,2),(3,99,0,1,4),(4,97,0,2,1),(5,136,0,2,2),(6,99,0,2,4);
...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb3 COMMENT='Catalog Product Media Gallery Attribute Backend Table';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `catalog_product_entity_media_gallery` VALUES (1,90,'/d/e/descarga_1_.png','image',0),(2,90,'/d/e/descarga_1__1.png','image',0);
...
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb3 COMMENT='Catalog Product Media Gallery Attribute Value Table';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `catalog_product_entity_media_gallery_value` VALUES (1,0,1,NULL,1,0,2),(2,0,2,NULL,1,0,3);
...
INSERT INTO `catalog_product_entity_text` VALUES (1,85,0,1,'js parte 1'),(2,85,0,2,'js parte 2');
...
) ENGINE=InnoDB AUTO_INCREMENT=37 DEFAULT CHARSET=utf8mb3 COMMENT='Catalog Product Varchar Attribute Backend Table';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `catalog_product_entity_varchar` VALUES (1,134,0,1,'2'),(2,87,0,1,'/d/e/descarga_1_.png'),(3,86,0,1,'js parte 1 '),(4,84,0,1,'js parte 1'),(5,124,0,1,'0'),(6,73,0,1,'js parte 1'),(7,106,0,1,'container2'),(8,104,0,1,'product-full-width'),(9,88,0,1,'/d/e/descarga_1_.png'),(10,135,0,1,'/d/e/descarga_1_.png'),(11,89,0,1,'/d/e/descarga_1_.png'),(12,121,0,1,'js-parte-1'),(21,134,0,2,'2'),(22,87,0,2,'/d/e/descarga_1__1.png'),(23,86,0,2,'js parte 2 '),(24,84,0,2,'js parte 2'),(25,124,0,2,'0'),(26,73,0,2,'js parte 2'),(27,106,0,2,'container2'),(28,104,0,2,'product-full-width'),(29,88,0,2,'/d/e/descarga_1__1.png'),(30,135,0,2,'/d/e/descarga_1__1.png'),(31,89,0,2,'/d/e/descarga_1__1.png'),(32,121,0,2,'js-parte-2');
...
INSERT INTO `catalog_product_index_price` VALUES (1,0,1,2,100.000000,100.000000,100.000000,100.000000,NULL),(1,1,1,2,100.000000,100.000000,100.000000,100.000000,NULL),(1,2,1,2,100.000000,100.000000,100.000000,100.000000,NULL),(1,3,1,2,100.000000,100.000000,100.000000,100.000000,NULL),(2,0,1,2,1000.000000,1000.000000,1000.000000,1000.000000,NULL),(2,1,1,2,1000.000000,1000.000000,1000.000000,1000.000000,NULL),(2,2,1,2,1000.000000,1000.000000,1000.000000,1000.000000,NULL),(2,3,1,2,1000.000000,1000.000000,1000.000000,1000.000000,NULL);
...
INSERT INTO `catalog_product_index_website` VALUES (1,1,'2022-12-31',1);
...
INSERT INTO `cataloginventory_stock_item` VALUES (1,1,1,1000.0000,0.0000,1,0,0,1,1.0000,1,10000.0000,1,1,NULL,1.0000,1,1,1,0,1,1.0000,1,0,0,0),(2,2,1,10.0000,0.0000,1,0,0,1,1.0000,1,10000.0000,1,1,NULL,1.0000,1,1,1,0,1,1.0000,1,0,0,0);
...
INSERT INTO `cataloginventory_stock_status` VALUES (1,0,1,1000.0000,1),(2,0,1,10.0000,1);
...
) ENGINE=InnoDB AUTO_INCREMENT=23 DEFAULT CHARSET=utf8mb3 COMMENT='Config Data';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `core_config_data` VALUES (1,'default',0,'catalog/search/engine','elasticsearch7','2022-12-31 04:43:01'),(2,'default',0,'catalog/search/elasticsearch7_server_hostname','localhost','2022-12-31 04:43:01'),(3,'default',0,'catalog/search/elasticsearch7_server_port','9200','2022-12-31 04:43:01'),(4,'default',0,'catalog/search/elasticsearch7_index_prefix','m2_test','2022-12-31 04:43:01'),(5,'default',0,'catalog/search/elasticsearch7_server_timeout','15','2022-12-31 04:43:01'),(6,'default',0,'web/seo/use_rewrites','1','2022-12-31 04:43:01'),(7,'default',0,'web/unsecure/base_url','http://josepintado.local/','2022-12-31 04:43:01'),(8,'default',0,'general/locale/code','en_US','2022-12-31 04:43:01'),(9,'default',0,'general/locale/timezone','America/Lima','2022-12-31 04:43:01'),(10,'default',0,'currency/options/base','USD','2022-12-31 04:43:01'),(11,'default',0,'currency/options/default','USD','2022-12-31 04:43:01'),(12,'default',0,'currency/options/allow','USD','2022-12-31 04:43:01'),(13,'default',0,'general/region/display_all','1','2022-12-31 04:43:01'),(14,'default',0,'general/region/state_required','AL,AR,AU,BG,BO,BR,BY,CA,CH,CL,CN,CO,DK,EC,EE,ES,GR,GY,HR,IN,IS,IT,LT,LV,MX,PE,PL,PT,PY,RO,SE,SR,US,UY,VE','2022-12-31 04:43:05'),(15,'default',0,'catalog/category/root_id','2','2022-12-31 04:43:06'),(16,'default',0,'analytics/subscription/enabled','1','2022-12-31 04:43:07'),(17,'default',0,'crontab/default/jobs/analytics_subscribe/schedule/cron_expr','0 * * * *','2022-12-31 04:43:07'),(18,'default',0,'crontab/default/jobs/analytics_collect_data/schedule/cron_expr','00 02 * * *','2022-12-31 04:43:07'),(19,'default',0,'msp_securitysuite_recaptcha/frontend/enabled','0','2022-12-31 04:43:08'),(20,'default',0,'msp_securitysuite_recaptcha/backend/enabled','0','2022-12-31 04:43:08'),(21,'default',0,'twofactorauth/duo/application_key','xF2emivi7FMwPzOsFZbyHnrY9tOlAmjlf5ruvQqriLsSicPBgPEL5oqpEOpQUxLe','2022-12-31 04:43:09'),(22,'default',0,'admin/usage/enabled','1','2022-12-31 22:37:00');
...
INSERT INTO `flag` VALUES (1,'analytics_link_attempts_reverse_counter',0,'24','2022-12-31 04:43:07');
...
INSERT INTO `indexer_state` VALUES (1,'design_config_grid','valid','2022-12-31 21:12:31','569d0f5fe3aa1f0a0e84e2ae8a90c276'),(2,'customer_grid','valid','2022-12-31 04:43:10','a4346f0b8c99ea7f0e2ccb638ee9ba8d'),(3,'catalog_category_product','invalid','2022-12-31 04:43:05','d40b6553038ca2503603178abdad62f5'),(4,'catalog_product_category','invalid','2022-12-31 04:43:05','be944220cd22cdcfbfbc12abf290ca3e'),(5,'catalogrule_rule','invalid','2022-12-31 04:43:05','5b4ff118bff57aa04a0eea498c4865df'),(6,'catalog_product_attribute','invalid','2022-12-31 04:43:05','43b2d30f6ce727d588479be4103e3afc'),(7,'cataloginventory_stock','invalid','2022-12-31 04:43:05','f372c0a9f6d08e4f19410ebf2465e167'),(8,'inventory','invalid','2022-12-31 04:43:05','878b04297436d9920a70f21460718f0a'),(9,'catalogrule_product','invalid','2022-12-31 04:43:05','3e7654f0844ac6f254174c29017fca5b'),(10,'catalog_product_price','invalid','2022-12-31 04:43:05','6193b64ef87021ba81876614465d4e01'),(11,'catalogsearch_fulltext','invalid','2022-12-31 04:43:05','86eb6f108228e9280ac53e4adf8f0884');
...
INSERT INTO `inventory_low_stock_notification_configuration` VALUES ('default','js parte 1',NULL),('default','js parte 2',NULL);
...
INSERT INTO `inventory_source_item` VALUES (1,'default','js parte 1',1000.0000,1),(5,'default','js parte 2',10.0000,1);
...
INSERT INTO `queue_poison_pill` VALUES ('version-63b0b98c826d5');
...
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=utf8mb3 COMMENT='Search query table';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `search_query` VALUES (1,'js',0,0,NULL,1,1,1,0,'2022-12-31 23:35:37'),(3,'js parte 1',2,2,NULL,1,1,1,0,'2023-01-02 17:14:19'),(5,'js parte',2,2,NULL,1,1,1,0,'2022-12-31 23:37:35');
...
INSERT INTO `theme` VALUES (1,NULL,'Magento/blank','Magento Blank','preview_image_63afbdd9237c7.jpeg',0,'frontend',0,'Magento/blank'),(2,NULL,'Magento/backend','Magento 2 backend',NULL,0,'adminhtml',0,'Magento/backend'),(3,1,'Magento/luma','Magento Luma','preview_image_63afbdd92d3e4.jpeg',0,'frontend',0,'Magento/luma');
...
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb3 COMMENT='Url Rewrites';
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Dumping routines for database 'm2_test'
--
...
/*!50013 DEFINER=`admin`@`localhost` SQL SECURITY INVOKER */
...
-- Dump completed on 2023-01-02 15:12:49
